...
Link.args = { link: 'https://chat.rockylinux.org', children: "Join the discussion" };

export const PreIcon = Template.bind({});
PreIcon.args = { link: 'https://chat.rockylinux.org', preIcon: (<ChatAlt2Icon />), children: "Join the discussion" };
...
PrimaryIconOnly.args = { primary: true, icon: true, children: (<ArrowNarrowRightIcon />) };
